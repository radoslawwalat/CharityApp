        ...
        <div class="card-body p-0">
            ...
            <div class="p-5">
                <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Edytuj swoje dane ${user.username}</h1>
                </div>
<form:form modelAttribute="user" method="post" action="/profile/updateInfo" id="contact_form">
    <form:hidden path="id"/>
    ...
    <form:hidden path="blocked"/>
                    ...
                    <div class="form-group ">
                        <div class="mb-3 mb-sm-0">
                            ...
                            <form:input path="username" type="text" placeholder="Nazwa Użytkownika" class="form-control"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="mb-3 mb-sm-0">
